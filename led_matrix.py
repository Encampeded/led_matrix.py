...
class Matrix:
    ...
    def draw_line(self, point1, point2):
        ...
        # If not straight, go into bad diagonal line drawer
    ...
    def draw_rectangle(self, point1, point2, filled=False):
        ...
        if point1[0] > point2[0] or point1[1] > point2[1]:
            raise Exception(f"point1 ({point1}) must be the higher and to the left of point2 ({point2})")
    ...
    def send_matrix(self):
        ...
        for i in range(0, 312, 8):
            ...
            # Previous one-liner that I wrote out to make it a tad more readable
